...
public class KhachHang {
    ...
    private String email; // Có thể NULL trong CSDL
    private boolean gioiTinh; 
    // Đã loại bỏ: private NhanVien nhanVien; 

    // Constructor 1: Rỗng
    public KhachHang() {
    }

    // Constructor 2: Chỉ mã
    public KhachHang(String maKH) {
        this.maKH = maKH;
    }

    // Constructor 3: Đầy đủ tham số (không có NhanVien)
    ...
    public void setMaKH(String maKH) {
        if (maKH == null || maKH.trim().isEmpty()) {
            // Sửa lỗi: Dùng IllegalArgumentException
            throw new IllegalArgumentException("Mã khách hàng không được để trống.");
        }
        // Ràng buộc mới: Phải theo định dạng KHxxx (ví dụ: KH001)
    ...
    public void setSoDienThoai(String soDienThoai) {
        ...
        // Ràng buộc mới: 10 số, bắt đầu bằng 09 hoặc 03
...
//            throw new IllegalArgumentException("Email phải có định dạng hợp lệ (ví dụ: example@gmail.com).");
//        }
        this.email = email; 
    }

    public void setGioiTinh(boolean gioiTinh) {
        // Kiểu 'boolean' (primitive) không thể null, 
        // nên việc kiểm tra "chưa chọn" phải được xử lý ở tầng GUI.
        this.gioiTinh = gioiTinh; 
    }
