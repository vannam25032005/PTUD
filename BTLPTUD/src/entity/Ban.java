...
public class Ban {
    ...
    private String loaiBan; // Ví dụ: "Bàn nhỏ", "Bàn vừa", "Bàn lớn", "Phòng VIP"
    private int soGhe;
    private String khuVuc;  // Ví dụ: "Tầng 1", "Tầng 2", "Tầng 3"
    private String trangThai; // Ví dụ: "Trống", "Đã đặt", "Đang sử dụng", "Đang dọn"
